...
class PlaywrightExtractorUltimate:
    """
    ...
    async def _extract_data_playwright(self, page, network_capture):
        ...
        data = {
            ...
            "extractor": "Playwright Ultimate V3.0"
        }
        ...
        # Extract rating
        try:
            rating = await page.locator(".MW4etd, .ceNzKf").first.text_content()
            if rating:
        ...
        try:
            ...
            for pattern in place_id_patterns:
                ...
                if match:
                    data["place_id_raw"] = match.group(1)
                    break
        except:
            pass
        ...
        try:
            ...
            if images:
                ...
                data["image_count"] = len(data["photos"])
        except:
            pass
